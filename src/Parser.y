...
Constructor :
    id of Types                    { ConstructorDeclaration (Constructor $1) (reverse $3) }
  | id                             { ConstructorDeclaration (Constructor $1) [] }
...
Type :: { Ty }
Type :
  id                               { if $1 == "Symbol" then TySymbol else TyComposite (TyName $1) }
